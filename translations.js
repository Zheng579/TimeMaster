...
const TRANSLATIONS = {
    en: {
        ...
        timerPauseBtn: 'Pause',
        timerResetBtn: 'Reset',
        cycleTimerTitle: 'Focus cycle timer',
        cycleTimerFocusMinutesLabel: 'Focus min',
        cycleTimerFocusSecondsLabel: 'Focus sec',
        cycleTimerBreakMinutesLabel: 'Break min',
        cycleTimerBreakSecondsLabel: 'Break sec',
        cycleTimerCyclesLabel: 'Cycles',
        cycleTimerStopBtn: 'Stop',
        cycleTimerPhaseFocus: 'Focus',
        cycleTimerPhaseBreak: 'Break',
        cycleTimerPhaseComplete: 'Complete',
        cycleTimerPhaseCycle: '{phase} · Cycle {current} of {total}',
        statusNoTimerSet: 'No timer set.',
        statusCycleTimerSetFirst: 'Set a focus time, break time, and cycle count first.',
    ...
    zh: {
        ...
        timerPauseBtn: '暫停',
        timerResetBtn: '重設',
        cycleTimerTitle: '專注循環計時器',
        cycleTimerFocusMinutesLabel: '專注（分）',
        cycleTimerFocusSecondsLabel: '專注（秒）',
        cycleTimerBreakMinutesLabel: '休息（分）',
        cycleTimerBreakSecondsLabel: '休息（秒）',
        cycleTimerCyclesLabel: '循環次數',
        cycleTimerStopBtn: '停止',
        cycleTimerPhaseFocus: '專注',
        cycleTimerPhaseBreak: '休息',
        cycleTimerPhaseComplete: '完成',
        cycleTimerPhaseCycle: '{phase} · 第 {current} / {total} 次循環',
        statusNoTimerSet: '尚未設定計時器。',
        statusCycleTimerSetFirst: '請先設定專注時間、休息時間和循環次數。',

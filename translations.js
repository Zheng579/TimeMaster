...
const TRANSLATIONS = {
    en: {
        ...
        btnLogHighlightedTime: 'Highlight time',
        ...
        tableHeaderLogInterval: 'Log Interval',
        alarmStopSound: 'Stop Sound',
        alarmSoundFileLabel: 'Alarm sound (MP3)',
        alarmSoundDefault: 'Using default beep.',
        alarmSoundSelected: 'Selected: {name}',
        alarmSoundInvalid: 'Please select an MP3 file.',
    ...
    zh: {
        ...
        tableHeaderLogInterval: '记录间隔',
        alarmStopSound: '停止声音',
        alarmSoundFileLabel: '闹钟声音（MP3）',
        alarmSoundDefault: '正在使用默认提示音。',
        alarmSoundSelected: '已选择：{name}',
        alarmSoundInvalid: '请选择 MP3 文件。',
        clockPanelTitle: '时钟',
